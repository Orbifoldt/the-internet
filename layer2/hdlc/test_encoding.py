...
from layer2.hdlc.encoding import encode, encode_bytes
from layer2.hdlc.hdlc import HdlcIFrame, HdlcFrameBase, HdlcMode
...
class Test(TestCase):
    ...
    def test_encode_async_mode_with_escaped_info(self):
        information = b'Some information that' + HdlcFrameBase.flag + b' we send' + HdlcFrameBase.escape_byte + \
                      b' in this frame!'
        escaped_information = b'Some information that' + HdlcFrameBase.escape_byte + b'\x5E' \
                              + b' we send' + HdlcFrameBase.escape_byte + b'\x5D' + b' in this frame!'
